...
function logsDir() {
  const raw = process.env.MDATA_LOGS_DIR && String(process.env.MDATA_LOGS_DIR).trim();
...
function initMdataConsoleFileLogging() {
...
module.exports = { initMdataConsoleFileLogging };
