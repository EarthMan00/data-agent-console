...
> = {
  ...
  "solid-mint": {
    fill: "var(--color-dot-mint)",
    glow: "var(--color-dot-mint)"
  },
  "grad-sunset": {
    fill: "var(--gradient-dmx-sunset)",
    glow: "var(--color-dot-sunset)"
  },
  "grad-ocean": {
    fill: "var(--gradient-dmx-ocean)",
    glow: "var(--color-dot-ocean)"
  },
  "grad-neon": {
    fill: "var(--gradient-dmx-neon)",
    glow: "var(--color-dot-neon)"
  },
  "grad-aurora": {
    fill: "var(--gradient-dmx-aurora)",
    glow: "var(--color-dot-aurora)"
  },
  "grad-fire": {
    fill: "var(--gradient-dmx-fire)",
    glow: "var(--color-dot-fire)"
  },
  "grad-prism": {
    fill: "var(--gradient-dmx-prism)",
    glow: "var(--color-dot-prism)"
  }
};
