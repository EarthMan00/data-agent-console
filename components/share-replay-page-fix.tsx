  ...
  return (
    <div className="min-h-screen bg-fill-hover text-foreground">
      ...
      <div className="mx-auto max-w-5xl px-6 py-8">
        {share.description ? (
          <p className="mb-4 text-caption text-text-tertiary">{share.description}</p>
        ) : null}
        ...
        {linkedRun ? (
          <div className="mt-6 space-y-3">
            <div className="text-body font-semibold text-foreground">已加载工作区回放</div>
            {linkedRun.sections.map((section) => (
              <div key={section.id} className="rounded-field border border-border-subtle bg-bg-subtle px-4 py-3">
          ...
          <p className="mt-6 text-caption text-text-disabled">
